        ...
        >
          <div className="p-6 space-y-4 ">
            ...
            <p className="text-base text-primary">
              <strong>SprintBuild</strong> is an end-to-end AI coding platform
              where you enter a prompt and the agent ships a full-stack
              application in a sandboxed environment with live preview.
            </p>
